...
class Authors
{
    ...
    protected static $custom_type = 'author';
    protected static $singular_name = 'Author';
    protected static $plural_name = 'Authors';
    protected static $dashboard_icon = 'dashicons-admin-users'; // https://developer.wordpress.org/resource/dashicons/
