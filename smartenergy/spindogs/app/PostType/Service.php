...
class Service
{
    ...
    protected static $custom_type = 'service';
    protected static $singular_name = 'Service';
    protected static $plural_name = 'Services';
    protected static $archive_url = 'services';
    protected static $dashboard_icon = 'dashicons-cover-image'; // https://developer.wordpress.org/resource/dashicons/
    protected static $admin_page_option_name = 'service_archive';
