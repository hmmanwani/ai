...
class CaseStudy
{
    ...
    protected static $custom_type = 'study';
    protected static $singular_name = 'Case Study';
    protected static $plural_name = 'Case Studies';
    protected static $archive_url = 'case-studies';
    protected static $dashboard_icon = 'dashicons-welcome-widgets-menus'; // https://developer.wordpress.org/resource/dashicons/
    protected static $admin_page_option_name = 'study_archive';
