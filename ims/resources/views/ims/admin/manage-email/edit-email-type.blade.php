...
<body>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="{{ URl('submit-edit-email-type') }}" method="POST">
                                                        @csrf
                                                        <div class="row">
                                                            {{-- type  --}}
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="col-md-12 justify-content-end d-flex p-0">
                                                                    <a class="btn btn-primary add-email-input "
                                                                ...
                                                                <div class="row email-to-inputs">
                                                                    <?php
                                                                    $emailArray = explode(',', $data->email_to);
                                                                    ?>

                                                                    @foreach ($emailArray as $index => $item)
                                                                        <div class="col-md-4 email-to-field">
                                                                            <div class="form-group">
                                                                                <label class="required"
                                                                                    for="email_to">Email To</label>
                                                                                <div class="d-flex align-items-center">
                                                                                    ...
                                                                                    @if ($index > 0)
                                                                                        <a href="#"
                                                                                            class="btn f-red btn-sm ml-2 remove-email-to-input">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="row email-cc-inputs">
                                                                    <?php
                                                                    $emailccArray = explode(',', $data->email_cc);
                                                                    ?>
                                                                    @foreach ($emailccArray as $index => $item)
                                                                        <div class="col-md-4 email-cc-field">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="d-flex align-items-center">
                                                                                    <input type="email"
                                                                                        name="email_cc[]" id="email_cc"
                                                                                        value="{{ $item }}"
                                                                                        class="form-control" required>
                                                                                    @if ($index > 0)
                                                                                        <a href="#"
                                                                                            class="btn f-red btn-sm ml-2 remove-email-cc-input">
                                                                                            <i class="fa fa-trash"></i>
                                                                                        </a>
                                                                                    @endif
                                                                                    <div class="invalid-feedback"
    ...
    <script>
        ...
        `;
                ...
                var lastInput = $('.email-to-inputs .col-md-4').last();
                var newElement = $(newEmailInput).insertAfter(lastInput);
    ...
    <script>
        $(document).ready(function() {
            ...
            <div class="col-md-4 email-cc-field" style="display:none;">
                <div class="form-group">
                    ...
                    <div class="d-flex align-items-center">
                        <input type="email" name="email_cc[]" id="email_cc" class="form-control" required>
        ...
        `;
                ...
                var lastInput = $('.email-cc-inputs .col-md-4').last();
                var newElement = $(newEmailInput).insertAfter(lastInput);
                newElement.hide().fadeIn(500);
            });
