                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card f-black">
                                        <div class="card-header">
                                            <div class="row">
                                                <div class="col-md-6 align-self-center">
                                                    <h2 class="f-700 f-black">Edit Project</h2>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <form id="MyForm" action="{{ url('submit-edit-project-details') }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="required f-600" for="emp">Project
                                                                Leader</label>
                                                            <select name="emp[]" id="emp"
                                                                class="form-select chosen-select" multiple>
                                                                <option value="" disabled
                                                                    class="f-black d-flex f-700">-Select Members-
                                                                </option>
                                                                @foreach ($emp as $emps)
                                                                    <option value="{{ $emps->e_id }}"
                                                                        @if (is_array($employee) && in_array($emps->e_id, $employee)) selected @endif
                                                                        class="f-500">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="project_description" name="project_description" class="form-control" placeholder="Enter Project Title">{{ $data->project_description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        $(document).ready(function() {
            $('#project_description').summernote({
                ...
                onChange: function(contents, $editable) {
                    $('#project_description_hidden').val(contents);
                }
            });
