...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Add Daily Work Report'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="card f-black">
                                        <div class="card-header">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 d-flex justify-content-end">
                                                    <a href="<?php echo e(URL('daily-work-report')); ?>" class="me-2">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form id="workreport" action="<?php echo e(URL('submit-add-work-report')); ?>"
    ...
    <script>
        $(document).ready(function() {
            ...
            <?php if($showtask == 0): ?>
                ...
                const loginTime = `<?php echo e($loginTime); ?>`;
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/project/daily-work-report/add-work-report.blade.php ENDPATH**/ ?>