...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Add Emergency Contact'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?php echo e(URL('submit-emergency-contect')); ?>" method="POST"
                                                id="myForm">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/profile/add-emergencycontact.blade.php ENDPATH**/ ?>