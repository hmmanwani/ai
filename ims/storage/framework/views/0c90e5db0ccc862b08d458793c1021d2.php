...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Leave Type'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
        ...
        <div class="modal-dialog modal-dialog-centered 	modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(url('/submit-leave-types')); ?>" method="POST" id="MyFrom">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/admin/leave/leave-type.blade.php ENDPATH**/ ?>