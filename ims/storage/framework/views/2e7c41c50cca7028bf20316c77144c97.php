...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Resignation '] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="<?php echo e(URL('submit-resignation')); ?>" method="POST"
                                                id="myForm">
                                                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/resignation/resignation.blade.php ENDPATH**/ ?>