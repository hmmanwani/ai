...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Add Eduction Qualification'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?php echo e(URL('submit-education-qualification')); ?>" method="POST"
                                                id="myForm">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col-md-6">
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/profile/add-educationqualification.blade.php ENDPATH**/ ?>