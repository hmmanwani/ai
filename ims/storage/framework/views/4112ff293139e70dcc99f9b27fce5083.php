...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Edit Emergency Contact'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?php echo e(url('update-emergency-contact')); ?>" method="POST"
                                                id="myForm">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <input type="hidden" name="id" value="<?php echo e($data->ec_id); ?>">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                <input type="text" id="relationship"
                                                                    ...
                                                                    value="<?php echo e($data->relationship); ?>"
                                                                    pattern="[A-Za-z]+">
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/profile/edit-emergency-contact.blade.php ENDPATH**/ ?>