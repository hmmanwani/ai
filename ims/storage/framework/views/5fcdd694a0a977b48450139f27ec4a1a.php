...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Add Bank Information'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?php echo e(URL('submit-bank-information')); ?>" method="POST"
                                                id="myForm">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col-md-4">
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/profile/add-bank-infomation.blade.php ENDPATH**/ ?>