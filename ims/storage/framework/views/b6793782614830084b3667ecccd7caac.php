...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Work From Home'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card f-black">
                                        ...
                                        <div class="card-body">
                                            <form action="<?php echo e(url('submit-wfh')); ?>" method="POST" id="wfh">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col-md-4">
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/attendance/work-from-home.blade.php ENDPATH**/ ?>