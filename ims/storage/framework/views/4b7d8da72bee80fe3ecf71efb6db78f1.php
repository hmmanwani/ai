...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | Forgot Password'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
        ...
        <div class="container form-container">
            <div class="row form-row align-content-center">
                <div class="col-md-8 ">
                    ...
                    <div class="card mt-5">
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(URL('/submit-forgot-password')); ?>" id="myForm">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                                ...
                                <div class=" d-flex justify-content-between align-items-center">
                                    <a class="text-decoration-none login-button " href="<?php echo e(URL('/')); ?>">Login?</a>
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/login/forgot-password.blade.php ENDPATH**/ ?>