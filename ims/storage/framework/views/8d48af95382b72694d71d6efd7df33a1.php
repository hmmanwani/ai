...
<?php $component = App\View\Components\Head::resolve(['title' => 'IMS | All Work Form Home'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('body').on('click', 'a[id^="deleteWfh_"]', function() {
                var id = $(this).data('id');
                $('#wfhId').val(id);
                $('#confirmDeleteBtn').attr('href', "<?php echo e(url('DeleteWfh')); ?>/" + id);
...
<?php /**PATH /home/imshmmbiz/public_html/resources/views/ims/admin/wfh/approved-wfh.blade.php ENDPATH**/ ?>